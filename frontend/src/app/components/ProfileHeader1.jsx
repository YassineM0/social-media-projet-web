        ...
        <div className="relative h-5 w-auto mx-1.5 mt-1.5 ">
          ...
          <div className='flex float-right mr-56 space-x-1'>
            <div className=' bg-gray1 text-center w-3 h-1 text-white hover:bg-blue hover:text-black hover:tracking-wider rounded-md       transition-smooth duration-500 p-1 right-7 translate-y-1/2 '>
                <button className='inline text-sm font-sans' onClick={handleEditClick}>Edit Profile</button>
            </div>
          ...
          <div className="flex flex-col items-center w-4.5 p-2 bg-white border-3 border-gray2 rounded-mdd space-y-2 ml-3  mt-4 h-fit ">
              <div className="flex flex-col space-y-1 text-center w-full">
                <div className="border-b-2 border-gray3 pb-2 ">
                  ...
                  <p className="text-lg font-semibold text-gray-700">{user.dateOfBirth}</p>
                )}
                </div>
                <div className="border-b-2 border-gray3 pb-2">
                  ...
                  <p className="text-lg font-semibold text-gray-700">{user.location}</p>
                )}
                </div>
                <div className="">
                  ...
                  <p className="text-lg font-semibold text-gray-700">{user.occupation}</p>
                )}
                </div>
              </div>
            </div>
            ...
            <div className='mt-2 flex justify-center'>
              <button onClick={handleSaveClick} className=' bg-gray1 text-center w-3 h-1 text-white hover:bg-blue hover:text-black hover:tracking-wider rounded-md       transition-smooth duration-500 p-1'>
                Save
              </button>
            </div>
          )}
